    ...
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            <a href="/" className="flex items-center gap-x-2">
              <img 
                src="/lovable-uploads/23c081a9-5fd5-497c-92cd-7f432d115a8d.png" 
                alt="ColorGraph.AI Logo" 
                className="h-8 sm:h-10 animate-fade-in" 
              />
            </a>
          </div>
          ...
          <div className="hidden md:block animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <Button 
              className="cta-button bg-brand-purple hover:bg-brand-purple/90 text-white font-medium px-6 py-2 rounded-full"
            >
              Join our waitlist !
            </Button>
          </div>
      ...
      <div className={`md:hidden ${mobileMenuOpen ? "block" : "hidden"}`}>
        <div className="px-2 pt-2 pb-4 space-y-1 sm:px-3 bg-white shadow-lg">
          ...
          <div className="pt-2">
            <Button 
              className="w-full cta-button bg-brand-purple hover:bg-brand-purple/90 text-white font-medium px-6 py-2 rounded-full"
            >
              Join our waitlist !
            </Button>
          </div>
