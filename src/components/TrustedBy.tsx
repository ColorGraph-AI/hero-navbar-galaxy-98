    ...
    <div className="mt-16 w-full">
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8 lg:gap-12">
        <img
          ...
          alt="Rice University"
          className="h-10 w-auto opacity-100 hover:opacity-80 transition-all duration-300"
        />
        <img
        ...
        <img
          ...
          alt="Upwork"
          className="h-8 w-auto opacity-100 hover:opacity-80 transition-all duration-300"
        />
        <img
